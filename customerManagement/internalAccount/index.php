...
<div id="body_general">
<div id="accounttile">Device SetUp 
...
<div id="indidual_general">
  <div id="indidual_general2">
      <table width="560" border="1">
        <tr>
          <td width="116"><div id="inputName">Brand:</div></td>
          <td width="145"><div id="formInputs">
            <input type="text" value="" />
          </div></td>
         </tr>
         
          <tr>
          <td width="110"><div id="inputName">Model:</div></td>
          <td width="161"><div id="formInputs">
      ...
      <table class="datatable" id="genericTableFormtable" summary="System Resources">
          <tbody>
            <tr>
              ...
              <th width="49"><div id="datatableColcontent">Brand</div></th>
              <th width="64"><div id="datatableColcontent">Model</div></th>
            </tr>
