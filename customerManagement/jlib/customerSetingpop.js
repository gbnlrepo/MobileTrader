...
(function() {
	...
	function CustomerSepop(args) {
        ...
        top.CustomerSepop.instances[this.id] = this;
		
		this.init();
	};
	
	CustomerSepop.prototype = {
		...
		destroy: function() {
			...
			delete top.CustomerSepop.instances[this.id];
			
			top.CustomerSepop.id--;
		}
	};
	
    if (!top.CustomerSepop) {
		CustomerSepop.zIndexCounter = 1000;
		CustomerSepop.id = 0;
		CustomerSepop.instances = {};
		
		top.CustomerSepop = CustomerSepop;
	}
