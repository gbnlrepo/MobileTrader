...
<div id="body_general">
<div id="accounttile">Standing Order Settings
...
<table width="650" border="1" style="border-bottom: solid 1px #E5E5E5; padding-bottom:7px; margin-bottom:5px;">
            <tr>
...
<table width="650" border="1" >
  ...
  <tr>
    <td><div id="inputName">Local/Remote Branch: </div></td>
  ...
  <tr>
    <td><div id="inputName">Date Opened:</div></td>
    <td><div id="formInputs"><input type="text" value="" /></div></td>
    </tr>
  <tr>
  ...
  <tr>
    <td><div id="inputName">Starting Trx Date:</div></td>
    <td><div id="formInputs">
      <input name="text2" type="text" value="" />
    </div></td>
    </tr>
  <tr>
    <td><div id="inputName">Standing Order Frequency:</div></td>
    <td><div id="formInputs">
                <select name="select">
                  <option value=""></option>
                </select>
  ...
  <tr>
    <td><div id="inputName">Standing Over Period:</div></td>
    <td><div id="formInputs">
      <input name="text2" type="text" value="" />
    </div></td>
  </tr>
...
<div id="table_results_members" style="width:700px; margin-top:10px; height:200px; margin-bottom:0px; margin-left:30px;">
  ...
  <div style="padding:10px; background:#EEEEEE ;border: solid 1px #E5E5E5; width:780px; margin-left:17px;"></div>
</div>
