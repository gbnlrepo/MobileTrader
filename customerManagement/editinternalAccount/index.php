<script src="../../editinternalAccount/jlib/menulib.js"></script>
<script src="../../editinternalAccount/jlib/pop.js"></script>
<script src="../../editinternalAccount/jlib/mempop.js"></script>
<script src="../../editinternalAccount/jlib/normarizr.js"></script>


<div id="body_general">
<div id="accounttile">Edit Internal Account/Sub Account  :: Search Customer Details (by Name, NUBAN Code, A/C No & BVN.)
<span id="close"><img src="../../editinternalAccount/jlib/cancel_icon.png"  /></span>
</div>
...
<div id="table_results_members" style="width:700px; margin-top:10px; height:200px; margin-bottom:0px; margin-left:17px;">
  ...
  <div style="padding:10px; background:#EEEEEE ;border: solid 1px #E5E5E5; width:680px; margin-left:17px;">
  
    <table class="tablebuttonbar" summary="">
      <tbody>
        <tr>
          <td width="398" class="tablecontrols">&nbsp;</td>
          <td width="248" class="tablenavigation">Showing 31 to 32 of 32&nbsp;&nbsp;&nbsp;<a href="#">Previous</a> <img src="../../editinternalAccount/image/buttonSeparator.gif" alt="" /> Next</td>
        </tr>
      </tbody>
    </table>
  </div>
