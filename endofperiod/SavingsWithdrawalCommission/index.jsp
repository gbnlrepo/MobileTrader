...
<div id="accounttile">Savings Withdrawal Commission 
...
<table width="476" border="0" cellpadding="0" cellspacing="0" style="margin-left:30px;">
  <tr>
    <td width="205"><div id="inputName" style="text-align:left">Savings Product :</div></td>
    <td width="271"><div id="formInputs">
        <select name="select" >
          <option value=""></option>
        </select>
    </div></td>
  ...
  <tr>
    ...
    <td><div id="formInputs" style="height:25px;">
     ...
     <tr>
       ...
       <tr>
       <td><div id="inputName" style="text-align:left">Withdrawal Commission  Fee:</div></td>
       <td><div id="formInputs" style="height:25px;">
           <input type="text" value="" readonly="readonly" style=" float:left;"/>
           <input type="text" value="" readonly="readonly" style="width:80px; float:left; margin-left:5px;"/>
       </div></td>
      </tr>
       <tr>
       ...
       <tr>
        ...
        <tr>
          <td width="405"><div id="inputName" style="text-align:left">
            ...
            Debit Commissions while Posting Withdrawals </div></td>
          </tr>
        <tr>
          <td width="405"><div id="inputName" style="text-align:left">
            <input name="Fees&amp;Charges3" type="checkbox" value="Fees &amp; Charges" />
            Account can be Overdrawn for Withdrawal Commissions </div></td>
          </tr>
      </table></td>
       </tr>
</table>
