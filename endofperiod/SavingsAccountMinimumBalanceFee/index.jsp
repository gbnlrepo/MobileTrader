...
<div id="accounttile">Savings Accounts Minimum Balance Fee  
...
<table width="540" border="0" cellpadding="0" cellspacing="0" style="margin-left:30px;">
  <tr>
    <td width="257"><div id="inputName" style="text-align:left">Savings Product:</div></td>
    <td width="283"><div id="formInputs">
        <select name="select" >
          <option value=""></option>
        </select>
    </div></td>
  ...
  <tr>
    ...
    <td><div id="formInputs" style="height:25px;">
     ...
     <tr>
       ...
       <tr>
       <td><div id="inputName" style="text-align:left">Savings Account Minimum Balance Fee:</div></td>
       <td><div id="formInputs" style="height:25px;">
