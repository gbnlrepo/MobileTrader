...
<div id="accounttile">Migration Fees Savings 
...
<table width="476" border="0" cellpadding="0" cellspacing="0" style="margin-left:30px;">
  <tr>
    <td width="205"><div id="inputName" style="text-align:left">Last Date of Reporting Month :</div></td>
  ...
  <tr>
    ...
    <td><div id="formInputs" style="height:25px;">
     ...
     <tr>
       ...
       <tr>
       <td><div id="inputName" style="text-align:left">Ledger Fee:</div></td>
       <td><div id="formInputs">
           <input name="text" type="text" value="" />
       </div></td>
      </tr>
       ...
       <tr>
       <td><div id="inputName" style="text-align:left">Minimum Balance:</div></td>
       <td><div id="formInputs">
           <input name="text" type="text" value="" />
       </div></td>
      </tr>
	   ...
	   <table width="354" border="0" cellpadding="0" cellspacing="0" style="width:350px; padding:5px;" >
        ...
        <tr>
          <td width="354"><div id="inputName" style="text-align:left">
            <input name="Fees&amp;Charges3" type="checkbox" value="Fees &amp; Charges" />
            Fee &amp; Charges On-Hold Account </div></td>
          </tr>
        <tr>
          <td width="354"><div id="inputName" style="text-align:left">
            <input name="Fees&amp;Charges3" type="checkbox" value="Fees &amp; Charges" />
            Fee &amp; Charges on Dormant Account </div></td>
          </tr>
      </table>
	   </td>
       </tr>
