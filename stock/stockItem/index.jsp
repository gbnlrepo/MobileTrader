...
<div id="accounttile">Stock Items
...
<table width="485" border="0" cellpadding="0" cellspacing="0" style="margin-left:70px;">
  <tr>
    <td width="112"><div id="inputName" style="text-align:left">Items Name:</div></td>
    <td width="373" align="left"><div id="formInputs">
      <input name="text" type="text" value="" style="width:200px;"/>
    </div></td>
    </tr>
    <tr>
    <td width="112"><div id="inputName" style="text-align:left">Item's Munimum Level:</div></td>
    <td width="373" align="left"><div id="formInputs">
