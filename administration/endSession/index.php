...
<div id="body_general">
<div id="accounttile">End Session
...
<div id="butoss" style="margin-top:10px;"> <input type="submit" value="Ok" /> <input type="submit" value="Logged-in" /> <input type="submit" value="Close"/></div>
</div>
