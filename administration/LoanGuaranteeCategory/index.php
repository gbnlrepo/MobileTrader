...
<div id="accounttile">Loan Guarantee Category
...
<table width="485" border="0" cellpadding="0" cellspacing="0" style="margin-left:70px;">
  <tr>
    <td width="112"><div id="inputName" style="text-align:left">Loan Guarantee Category:</div></td>
    <td width="373" align="left"><div id="formInputs">
      <input name="text" type="text" value=""/>
    </div></td>
    </tr>
  <tr>
    <td width="112"><div id="inputName" style="text-align:left">Provision Rate:</div></td>
    <td width="373" align="left"><div id="formInputs">
      <input name="text" type="text" value="" style="width:80px;"/>
    </div></td>
    </tr>
</table>
