...
<div class="menu-wrapper">
               <ul>
                ...
                <li class="" > 
                 <a href="javascript:void(0)"  class="actives"     id="d1" lang="af" xml:lang="af"><span class="tab"><span>&nbsp;&nbsp;County/Sub-County&nbsp;</span> </span> </a> 
                </li>
              
                <li class="" > 
                 <a href="javascript:void(0)"  class="noneactives"  id="d2" lang="af" xml:lang="af"><span class="tab"><span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;District&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></a>
                </li>
...
<table width="485" border="0" cellpadding="0" cellspacing="0" style="margin-left:70px;">
  <tr>
    <td width="112"><div id="inputName" style="text-align:left">District:</div></td>
    <td width="373" align="left"><div id="formInputs">
      <input name="text" type="text" value=""/>
    </div></td>
    </tr>
</table>
<div id="butoss" style=" margin-left:70px; margin-top:30px;"><button> Add </button> 
<button>Update</button> <button>Delete</button>  <button>Close</button>
 </div>
...
<table width="485" border="0" cellpadding="0" cellspacing="0" style="margin-left:70px;">
  <tr>
    ...
    <td width="373" align="left"><div id="formInputs">
      ...
      <tr>
    <td width="112"><div id="inputName" style="text-align:left">County/Sub-County:</div></td>
    <td width="373" align="left"><div id="formInputs">
      <input name="text" type="text" value=""/>
    </div></td>
    </tr>
  <tr>
    <td width="112"><div id="inputName" style="text-align:left">Rural Area?:</div></td>
