...
<div id="accounttile">Define Cash/Bank/Transfer Accounts
...
<div id="uppers">
<table width="379" border="0" cellpadding="0" cellspacing="0" style="margin-left:70px; width:400px;">
  <tr>
    <td width="180"><div id="inputName" style="text-align:left">General Ledger A/C No.:</div></td>
    <td width="199"><div id="formInputs">
      <select name="select">
        <option value=""></option>
        </select>
    </div></td>
  ...
  <tr>
    <td><div id="inputName" style="text-align:left">Account No.:</div></td>
    <td><div id="formInputs">
      <input name="text" type="text" value="" />
    </div></td>
    </tr>
    <tr>
    <td><div id="inputName" style="text-align:left">Description:</div></td>
    <td><div id="formInputs">
      <input name="text" type="text" value="" />
    </div></td>
    </tr>
    <tr>
    <td><div id="inputName" style="text-align:left">A/C Type:</div></td>
    <td width="199"><div id="formInputs">
      <select name="select">
        <option value=""></option>
      </select>
...
<button>Update</button>   <input type="submit" value="Remove"/> <input type="submit" value="Close"/>
 </div>
