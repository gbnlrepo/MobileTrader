...
<div id="accounttile">Define Products
...
<table width="379" border="0" cellpadding="0" cellspacing="0" style="margin-left:70px; width:400px;">
  <tr>
    <td width="180"><div id="inputName" style="text-align:left">Product GL A/C No.:</div></td>
  ...
  <tr>
    <td><div id="inputName" style="text-align:left">Product Type:</div></td>
    <td width="199"><div id="formInputs">
      <select name="select">
        <option value=""></option>
      </select>
...
<button>Remove</button>  <input type="submit" value="Close"/>
 </div>
