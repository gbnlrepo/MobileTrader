...
<table width="485" border="0" cellpadding="0" cellspacing="0" style="margin-left:70px;">
  <tr>
    <td width="112"><div id="inputName" style="text-align:left">Bank Name:</div></td>
    <td width="373" align="left"><div id="formInputs">
      <input name="text" type="text" value=""/>
    </div></td>
    </tr>
  <tr>
    <td width="112"><div id="inputName" style="text-align:left">Branch Name:</div></td>
    <td width="373" align="left"><div id="formInputs">
      <input name="text" type="text" value=""/>
    </div></td>
    </tr>
